...
def salvar_base64_generico(base64_string: str, nome_base_arquivo: str) -> str | None:
    ...
    try:
        ...
        extensao = ".bin"  # Extensão genérica padrão caso não encontre nenhuma no cabeçalho
        ...
        print(f"📁 [Media Helper] Arquivo salvo em: {caminho_final}")
        return caminho_final

    except Exception as e:
        print(f"❌ [Media Helper] Erro ao processar Base64 genérico: {e}")
        return None